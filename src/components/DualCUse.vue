        ...
        <div class="col-md p-5">
            ...
            <el-form :model="form" label-width="auto" style="max-width: 600px">
              <el-form-item label="训练周期" size="large">
                <el-input v-model="form.xuexizhouqi1" />
              </el-form-item>
              <el-form-item label="嵌入维度" size="large">
                <el-input v-model="form.qianruweidu1" />
              </el-form-item>
              <el-form-item label="学习率" size="large">
                <el-input v-model="form.xuexilv1" />
              </el-form-item>
              <el-form-item label="Dropout率" size="large">
                <el-input v-model="form.dlv1" />
              </el-form-item>
              <el-form-item label="相似性权重" size="large">
                <el-input v-model="form.sim1" />
              </el-form-item>
            </el-form>
            ...
            <p></p>
            <!--上传参数和数据集-->
            <el-button class="ml-3" type="success" @click="submitUpload1;onSubmit1">
              上传数据集与参数表单，提交至服务器
            </el-button>
...
<style>
#building7{
  background:url("../assets/img/beijng7.png");
  width:100%;
  height:100%;
  position:fixed;
